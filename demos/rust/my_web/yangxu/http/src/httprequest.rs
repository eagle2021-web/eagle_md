...
impl From<String> for HttpRequest {
    fn from(req: String) -> Self {
        ...
        for line in req.lines() {
            ...
            } else if line.contains(":") && !read_body {
                println!("key-value line = {}", line);
...
impl HttpRequest {
    pub fn body_to_json(&self ) -> serde_json::error::Result<serde_json::Value>{

        return serde_json::from_str(&self.msd_body[..]);
    }
}
