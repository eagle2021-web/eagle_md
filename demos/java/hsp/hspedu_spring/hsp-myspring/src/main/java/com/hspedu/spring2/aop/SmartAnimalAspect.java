...
public class SmartAnimalAspect {
    ...
    //前置通知
    @Before(value = "execution(public float com.hspedu.spring2.aop.SmartDog.getSum(float, float))")
   ...
   //返回通知
    @AfterReturning(value = "execution(public float com.hspedu.spring2.aop.SmartDog.getSum(float, float))", returning = "res")
   ...
   //异常通知
    @AfterThrowing(value = "execution(public float com.hspedu.spring2.aop.SmartDog.getSum(float, float))", throwing = "throwable")
    ...
    //最终通知
    @After(value = "execution(public float com.hspedu.spring2.aop.SmartDog.getSum(float, float))")
